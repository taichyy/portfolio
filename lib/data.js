...
const projectsSource = [
...

    {
        ...
        overview: t(
            "以「未接來電」為核心概念，透過 Instagram 圖文連載、專題介紹影片、互動小遊戲與周邊商品，把常見症狀包裝成有趣的角色與故事。",
            "Built around the idea of the missed call, packaged common symptoms as characters and stories through an illustrated Instagram series, feature videos, interactive mini-games and merchandise.",
        ),
        context: t(
